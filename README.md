...
| [--skip-indexes[=SKIP-INDEXES]](https://kitloong.github.io/laravel-migrations-generator/options/skip-indexes/)        | Don\'t generate secondary indexes, or the specified index types                                                                                               |
| [--skip-foreign-keys](https://kitloong.github.io/laravel-migrations-generator/options/skip-foreign-keys/)              | Don\'t generate foreign keys                                                                                                                                  |
